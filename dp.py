...
# Wallet details
wallet = {
    'private_key': '0xa29488a9',  # Replace with actual private key
    'address': '0xDd417'       # Replace with actual wallet address
}
...
def main():
    ...
    transaction_count = 192  # Set the number of transactions to perform
